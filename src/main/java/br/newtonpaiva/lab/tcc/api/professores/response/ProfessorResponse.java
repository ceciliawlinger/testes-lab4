...
public class ProfessorResponse {
    ...
    public static ProfessorResponse buildFrom(Professor professor) {
        return new ProfessorResponse().withCreated(professor.getCreated()).withCurso(professor.getCurso())
                .withFormação(professor.getFormação()).withId(professor.getId()).withModified(professor.getModified())
